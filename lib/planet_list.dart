...
class PlanetList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Firestore.instance.collection("mensajes").document().setData({
      "mensaje": "Hello World"
    });
          ...
          child: StreamBuilder(
            ...
            builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
              ...
              return ListView.builder(
                ...
                new PlanetCard(
                    planet: Planet.fromFB(snapshot.data.documents[index])),
 ...
 /*ListView.builder(
          itemBuilder:(context, index )=> new PlanetCard(planet:_planets[index]),
